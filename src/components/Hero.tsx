...
const Hero = () => {
  ...
  return (
    <section className="hero-section relative px-4 py-16 overflow-hidden bg-gradient-to-b from-black/90 via-black/80 to-transparent">
      ...
      <div className="container mx-auto relative z-10 flex justify-center">
        <div className={`max-w-xl md:max-w-3xl text-center ${!isMobile ? 'px-8' : ''}`}>
          <h1 className="hero-heading-critical font-bold tracking-tight">
            Experience <span className="hero-gradient-text">AI-Enhanced Intimacy</span> for Deeper Connections
          </h1>
